...
// Initial load (skeletons → real data)
load();
...
# Skeleton cards for initial render
skel = ''.join([
...
"""
    extra_head = '<link rel="preload" href="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js" as="script"><script src="https://cdn.jsdelivr.net/npm/chart.js@4/dist/chart.umd.min.js" defer></script>'
    extra_js = f"""<script>
...
gallery_items = ""
for p in photos[:12]:
    # bug fix: use full data, not truncated
...
“=” * 80]
content_txt = “\n”.join(linhas)
fname = f”conversas_{di_str or ‘all’}*ate*{df_str or ‘hoje’}*{datetime.now().strftime(’%Y%m%d*%H%M’)}.txt”
